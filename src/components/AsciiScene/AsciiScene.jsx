...
function DraggableUserModel({ isHovered = false }) {
    ...
    const modelScale = isMobile ? 1.8 : 3;
...
export default function AsciiScene({ className, enableZoom = true }) {
    ...
    return (
        ...
        >
            <Canvas
                style={{
                    filter: `drop-shadow(rgba(96, 93, 249, 0.7) 0px 0px 10px) 
                    drop-shadow(rgba(96, 93, 249, 0.7) 0px 0px 5px)`,
                }}
                dpr={Math.min(
